...
try:
    year = int(input("Enter the year for the commits (e.g., 2025): "))
except ValueError:
...
# Inicialize o commit inicial com a data
os.system(f'git commit --date="2025-01-01 12:00:00" -m "Initial commit"')
